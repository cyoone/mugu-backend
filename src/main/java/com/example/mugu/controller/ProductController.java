...
public class ProductController {
    ...
    public String update(@PathVariable Long product_id, @Valid @ModelAttribute("product") ProductUpdateDTO ProductUpdateDTO, BindingResult result, Model model,
        ...
        if (deleteImages != null) {
            productService.deleteImageByUrl(deleteImages);
        }
        // 새로운 이미지 추가
        if (newImages != null) {
        ...
        // 카테고리 아이디 설정
        ProductUpdateDTO.setCategory_id(category_id);

        productService.update(product_id, ProductUpdateDTO);
        // 수정된 상품 정보를 가져옴
